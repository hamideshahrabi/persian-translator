...
logger.info(f"Loaded OPENAI_API_KEY: {'Present' if OPENAI_API_KEY else 'Missing'}")
...
<html>
<head>
    <title>Persian to English Translator</title>
    <style>
        body {
...
<body>
    <h1>Persian to English Translator</h1>
    <textarea id="text" placeholder="Enter Persian text here..." dir="rtl"></textarea>
    <br>
    ...
    <script>
        ...
        // Also allow translation when pressing Enter in the textarea
...
async def translate(request: TranslationRequest):
    try:
        logger.info(f"Attempting to translate text: {request.text}")
